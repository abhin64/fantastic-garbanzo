...
export default function ExploreCard({ post, onClick }: Props) {
  ...
  return (
    <div
      ...
      className="break-inside-avoid mb-3 cursor-pointer group relative rounded-xl overflow-hidden bg-surface select-none transition-shadow duration-200 hover:shadow-card-hover"
      style={{
    ...
    >
      ...
      <div className="p-3 pt-2.5">
        ...
        <h3 className="text-h4 text-ink leading-snug">
          {post.title}
        </h3>
        {post.location && (
